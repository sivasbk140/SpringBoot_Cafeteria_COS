 ...
 *
 * <p>Used during the cart management flow before the customer proceeds
 * to checkout. Holds the food item reference, quantity, and calculated total price.</p>
 *
 * @since 1.0
 */
@Data
...
public class CartItemDto {
    ...
    /** Unique identifier of the food item in the cart. */
